...
Let's start with a simple model that considers the relationship between a demographic and the likelihood of imagining a fictional story based on a particular demographic variable. We'll just use the data from the first half of the concert.
